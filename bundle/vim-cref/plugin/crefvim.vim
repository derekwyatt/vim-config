...
if !hasmapto('<Plug>CRV_CRefVimVisual')
    vmap <silent> <unique> <Leader>dr <Plug>CRV_CRefVimVisual
endif
if !hasmapto('<Plug>CRV_CRefVimNormal')
    nmap <silent> <unique> <Leader>dr <Plug>CRV_CRefVimNormal
endif
if !hasmapto('<Plug>CRV_CRefVimAsk')
    map <silent> <unique> <Leader>dw <Plug>CRV_CRefVimAsk
endif
"if !hasmapto('<Plug>CRV_CRefVimInvoke')
"    map <silent> <unique> <Leader>dc <Plug>CRV_CRefVimInvoke
"endif
